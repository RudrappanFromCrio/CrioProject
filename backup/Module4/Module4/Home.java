...
public class Home {
    ...
    //         // box
    //         WebElement searchBox = driver.findElement(By.xpath("(//*[@class='MuiOutlinedInput-input MuiInputBase-input MuiInputBase-inputSizeSmall MuiInputBase-inputAdornedEnd css-b52kj1'])[1]"));
    //         searchBox.clear();
    ...
    //         WebDriverWait wait = new WebDriverWait(driver,30);
    //      wait.until(
    //         ExpectedConditions.or(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(),'"+product+"')]")),
    ...
    //         //     ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']"), product),
    //         // ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()=' No products found ']"))
    //         //  ));
    //         //  Thread.sleep(3000);
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElement(By.xpath("//*[text()=' No products found ']")).isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        // try {
            ...
            // List<WebElement> cartContents = cartParent.findElements(By.xpath("//div[@class='cart MuiBox-root css-0']//div[@class='MuiBox-root css-0']"));

            // ArrayList<String> actualCartContents = new ArrayList<String>();
            // for (WebElement cartItem : cartContents) {
            //     actualCartContents.add(cartItem.findElement(By.xpath("//div[@class='cart MuiBox-root css-0']//div[@class='MuiBox-root css-0']")).getText().split("\n")[0]);
            // }
