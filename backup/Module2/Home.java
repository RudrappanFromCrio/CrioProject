...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // box
            WebElement searhBoxElement=driver.findElement(By.xpath("//div[@class='MuiFormControl-root MuiTextField-root search-desktop css-i44wyl']//input"));
            searhBoxElement.clear();
            searhBoxElement.sendKeys(product);
            Thread.sleep(3000);
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             */
             ////div[@class='MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-2 css-1msksyp']/div/div
    ...
    public Boolean clickCheckout() {
        ...
        try {
            ...
            WebElement checkoutButtonElement=driver.findElement(By.xpath("//button[text()='Checkout']"));
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            ...
            for(WebElement cartItemElement:cartItemElements){
                String actualProductName=cartItemElement.findElement(By.xpath(".//div[@class='MuiBox-root css-1gjj37g']/div[1]")).getText();
                if(actualProductName.equals(productName)){
                    String quantityString=cartItemElement.findElement(By.xpath(".//div[@data-testid='item-qty']")).getText();
                    int actualQuantity=Integer.parseInt(quantityString);
                    while(true){
                        if(actualQuantity<quantity){
                            WebElement plusIcon=cartItemElement.findElement(By.cssSelector("svg[data-testid='AddOutlinedIcon']"));
                            plusIcon.click();
                        }else if(actualQuantity>quantity){
                            WebElement minusIcon=cartItemElement.findElement(By.cssSelector("svg[data-testid='RemoveOutlinedIcon']"));
                            minusIcon.click();
                        }
                        Thread.sleep(3000);
                        if(quantity==0){
                        ...
                        String quantityString1=cartItemElement.findElement(By.xpath(".//div[@data-testid='item-qty']")).getText();
