...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver, "Start Test Case", "TestCase01");
        ...
        logStatus("End TestCase", "Test Case 1: Verify user Registration : ", status ? "PASS" : "FAIL");
        takeScreenshot(driver, "End Test Case", "TestCase01");
        return status;
    }
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver, "Start Test Case", "TestCase02");
        ...
        takeScreenshot(driver, "End Test Case", "TestCase02");
        return !status;
    }
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "End Test Case", "TestCase03");
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "End Test Case", "TestCase04");
        return status;
    }
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "Start Test Case", "TestCase05");
        Boolean status;
        ...
        takeScreenshot(driver, "End Test Case", "TestCase05");
        return status;
    }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver, "Start Test Case", "TestCase06");
        ...
        takeScreenshot(driver, "End Test Case", "TestCase06");
        return status;
    }
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        takeScreenshot(driver, "Start Test Case", "TestCase07");
        ...
        homePage.PerformLogout();
        takeScreenshot(driver, "End Test Case", "TestCase07");
        return status;
    }

    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver, "Start Test Case", "TestCase08");
    ...
    private static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        ...
        status=homePage.verifyCartContents(expectedResult);
        logStatus("End TestCase", "TestCase 9 : In the new tab product should contain : YONEX Smash Badminton Racquet", status ? "PASS" : "FAIL");
    ...
    private static Boolean TestCase10 (RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        logStatus("Start TestCase", "Test Case 10: Handling windows", "DONE");
        ...
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("TestCase 10", "Test Case Failure. Happy Flow Test Failed", "FAIL");
        }
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 10: Handling windows : ", status ? "PASS" : "FAIL");
        }
        ...
        // wait1.until(ExpectedConditions.urlToBe(parentWindow));

        status=driver.getCurrentUrl().equals(parentWindow);
        if(!status){
        logStatus("Step Failure", "Test Case 10: Handling windows1",  status ? "PASS" : "FAIL");
        } 

         Set<String> allWindow=driver.getWindowHandles();
         driver.switchTo().window(allWindow.toArray(new String[allWindow.size()])[1]);
         status=driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/privacy-policy");
         
         if(!status){
         logStatus("Step Failure", "Test Case 10: Handling windows2",  status ? "PASS" : "FAIL");
         } 

         driver.switchTo().window(allWindow.toArray(new String[allWindow.size()])[0]);
         ...
         WebElement TermsOfServiceElement=driver.findElement(By.linkText("Terms of Service"));
               ...
               driver.switchTo().window(allWindow.toArray(new String[allWindow.size()])[2]);
               status=driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/terms-of-service");
               
               if(!status){
               logStatus("Step Failure", "Test Case 10: Handling windows3",  status ? "PASS" : "FAIL");
               } 

               driver.close();
               driver.switchTo().window(allWindow.toArray(new String[allWindow.size()])[1]).close();
               driver.switchTo().window(allWindow.toArray(new String[allWindow.size()])[0]);
               
             logStatus("End TestCase", "Test Case 10: Handling window", "DONE");
            return status;
        }

               

    private static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {

        Boolean status;
        logStatus("Start TestCase", "Test Case 11: contactUs", "DONE");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 11: contactUs : ", status ? "PASS" : "FAIL");
        }
        ...
        WebElement contactUsElement=driver.findElement(By.xpath("//*[@id='root']/div/div/div[5]/div[2]/p[3]"));
        ...
        WebElement contactNowButtonElement=driver.findElement(By.xpath("/html/body/div[2]/div[3]/div/section/div/div/div/form/div/div/div[4]/div/button"));
        contactNowButtonElement.click();

        WebDriverWait wait=new WebDriverWait(driver, 30);
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("/html/body/div[2]/div[3]/div/section/div/div/div/form/div/div")));
           
       

        logStatus("End TestCase", "Test Case 11: contactUs", "DONE");       
    ...
    private static Boolean TestCase12(RemoteWebDriver driver) throws InterruptedException {

        Boolean status;
        
        logStatus("Start TestCase",  "Test Case 12: iframe", "DONE");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase",
                    "Test Case 12: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                    status ? "PASS" : "FAIL");
            return false;
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        // WebElement parentElement=driver.findElement(By.xpath("//*[@id='root']/div/div[2]"));

        WebElement frameIpad=driver.findElement(By.xpath("//*[@id='root']/div/div[2]/div/iframe[1]"));
        driver.switchTo().frame(frameIpad);
        WebDriverWait wait2 = new WebDriverWait(driver, 30);
        wait2.until(ExpectedConditions.and(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@class='MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButtonBase-root  css-rfvjbl']")),ExpectedConditions.elementToBeClickable((By.xpath("//button[@class='MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButtonBase-root  css-rfvjbl']")))));
        driver.findElement(By.xpath("//button[text()='Buy Now']")).click();

        driver.navigate().back();
        // driver.switchTo().parentFrame();

        WebElement frameGalaxy=driver.findElement(By.xpath("//*[@id='root']/div/div[2]/div/iframe[2]"));
        driver.switchTo().frame(frameGalaxy);
        WebDriverWait wait3 = new WebDriverWait(driver, 30);
        wait3.until(ExpectedConditions.and(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@class='MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButtonBase-root  css-rfvjbl']")),ExpectedConditions.elementToBeClickable((By.xpath("//button[@class='MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButtonBase-root  css-rfvjbl']")))));
        driver.findElement(By.xpath("//button[text()='Buy Now']")).click();

        driver.navigate().back();
        // driver.switchTo().parentFrame();
        WebElement frameCorona=driver.findElement(By.xpath("//*[@id='root']/div/div[2]/iframe"));
        driver.switchTo().frame(frameCorona);
        WebDriverWait wait4 = new WebDriverWait(driver, 30);
        wait4.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='root']/div/div[2]/iframe")));
        
        driver.switchTo().parentFrame();

        logStatus("End TestCase",  "Test Case 12: iframe", "DONE");
        return true;
    }
